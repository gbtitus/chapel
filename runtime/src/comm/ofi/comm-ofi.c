...
void init_ofiDoProviderChecks(void) {
  ...
  //
  // Based on analyzing a segfault, RxD and perhaps others have to have
  // a non-NULL buf arg for fi_fetch_atomic(FI_ATOMIC_READ) even though
  // the fi_atomic man page says buf is ignored for that operation and
  // may be NULL.
  //
